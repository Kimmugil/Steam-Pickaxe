...
const FALLBACK: Record<string, string> = {
  ...
  ADMIN_TOOL_DEDUP_DESC: "전체 게임 타임라인에서 중복 항목을 탐지하고 제거합니다. 수집 오류로 동일 이벤트가 중복 저장된 경우 사용하세요.",
  ADMIN_BTN_DEDUP_EXEC: "🧹 중복 정리 실행",
  ADMIN_RETRIGGER_CONFIRM_DESC: "수집이 오류로 중단된 경우 사용하세요. 진행 중인 수집이 있다면 중복 실행될 수 있습니다.",
  ADMIN_MODAL_MONTH_INPUT_TITLE: "구간 재분석",
  ADMIN_MODAL_MONTH_INPUT_DESC: "재분석할 년월을 입력하세요. 해당 구간의 리뷰·이벤트를 현재 데이터 기준으로 다시 분석합니다.",
  ADMIN_MODAL_MONTH_PLACEHOLDER: "예: 2024-03",
  ADMIN_BTN_REANALYZE_EXEC: "재분석 실행",
  ADMIN_MODAL_INCOMPLETE_REVIEWS_TITLE: "수집이 완료되지 않은 게임입니다",
  ADMIN_MODAL_INCOMPLETE_REVIEWS_DESC: "{name}의 리뷰 수집이 완료되지 않았습니다.",
  ADMIN_MODAL_INCOMPLETE_REVIEWS_COUNTS: "수집 {collected}건 / Steam {total}건",
  ADMIN_MODAL_INCOMPLETE_REVIEWS_WARN: "지금 승인하면 수집된 데이터로만 분석됩니다.",
  ADMIN_BTN_APPROVE_NOW: "지금 바로 승인 + 분석 시작",
  ADMIN_BTN_APPROVE_WAIT: "승인만 (수집 완료 후 다음 자동 분석 대기)",
  ADMIN_BADGE_AUTO_REANALYZE: "🔁 자동재분석 예정",
  ADMIN_BADGE_AUTO_REANALYZE_TITLE: "리뷰가 {last}→{cur}건으로 {pct}% 증가해 다음 분석 시 자동 재분석됩니다.",
  ADMIN_LEGEND_AI: "AI 분석",
  ADMIN_LEGEND_COLLECT: "수집",
  ADMIN_LEGEND_DETECT: "감지·주의",
  ADMIN_LEGEND_MAINTAIN: "유지보수",
  ADMIN_SECTION_WORKFLOW: "워크플로우 현황",
  TH_WORKFLOW_SCHEDULE: "실행 주기",
  ADMIN_WF_CCU_NAME: "ccu.yml",
  ADMIN_WF_CCU_SCHEDULE: "매 시간 정각",
  ADMIN_WF_CCU_DESC: "현재 동접자 수 수집",
  ADMIN_WF_COLLECT_NAME: "collect.yml",
  ADMIN_WF_COLLECT_SCHEDULE: "매일 20:00 UTC",
  ADMIN_WF_COLLECT_DESC: "리뷰·이벤트·뉴스·메타데이터 수집",
  ADMIN_WF_ANALYZE_NAME: "analyze.yml",
  ADMIN_WF_ANALYZE_SCHEDULE: "매월 1일 00:00 UTC",
  ADMIN_WF_ANALYZE_DESC: "월별 AI 분석 (승인 게임만)",
  ADMIN_WF_SHIFTS_NAME: "detect-shifts.yml",
  ADMIN_WF_SHIFTS_SCHEDULE: "매주 월요일",
  ADMIN_WF_SHIFTS_DESC: "평가 급변 감지 + AI 원인 분석",
  ADMIN_WF_CORE_NAME: "core-analyze.yml",
  ADMIN_WF_CORE_SCHEDULE: "온디맨드",
  ADMIN_WF_CORE_DESC: "종합 분석 4종 즉시 갱신 (수집 없음)",
  ADMIN_WF_TIMELINE_NAME: "analyze.yml (타임라인)",
  ADMIN_WF_TIMELINE_SCHEDULE: "온디맨드",
  ADMIN_WF_TIMELINE_DESC: "전체 타임라인 월별 AI 재분석",
  ADMIN_WF_MONTH_NAME: "collect-month.yml",
  ADMIN_WF_MONTH_SCHEDULE: "온디맨드",
  ADMIN_WF_MONTH_DESC: "이번 달 수집 + AI 분석",
  ADMIN_WF_NEWS_NAME: "collect-game.yml",
  ADMIN_WF_NEWS_SCHEDULE: "온디맨드",
  ADMIN_WF_NEWS_DESC: "단일 게임 이벤트/뉴스 수집",
  ADMIN_WF_PENDING_NAME: "analyze.yml (미분석)",
  ADMIN_WF_PENDING_SCHEDULE: "온디맨드",
  ADMIN_WF_PENDING_DESC: "미분석 구간 선별 AI 분석",
  ADMIN_WF_RETRIGGER_NAME: "collect.yml (재시작)",
  ADMIN_WF_RETRIGGER_SCHEDULE: "온디맨드",
  ADMIN_WF_RETRIGGER_DESC: "전체 수집 즉시 재트리거",
  ADMIN_WF_RECALC_NAME: "recalc-lang-dist.yml",
  ADMIN_WF_RECALC_SCHEDULE: "온디맨드",
  ADMIN_WF_RECALC_DESC: "언어 분포 강제 재계산",
  ADMIN_WF_DEDUP_NAME: "dedup-timelines.yml",
  ADMIN_WF_DEDUP_SCHEDULE: "온디맨드",
  ADMIN_WF_DEDUP_DESC: "타임라인 중복 정리",
  ADMIN_TOAST_RECALC_LANG: "언어 분포 재집계를 시작했습니다.",
  ADMIN_TOAST_DEDUP_TIMELINES: "타임라인 중복 정리를 시작했습니다.",
  ADMIN_COL_REVIEWS_TH: "수집 / Steam 총계",
