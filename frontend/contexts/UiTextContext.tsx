...
const FALLBACK: Record<string, string> = {
  ...
  // ── 자동화 스케줄 ────────────────────────────────────────────────────
  GUIDE_SCH_INFO1: "AI 분석(analyze.yml)은 매월 1일 00:00 UTC에 전월 최종 분석을 실행합니다. 관리자는 게임별로 현재 월 수집+분석을 온디맨드로 트리거할 수 있습니다. 신규 게임은 관리자 승인 후 즉시 첫 분석이 실행됩니다.",
  ...
  GUIDE_SCH_T2_2: "매월 1일 00:00 UTC",
  GUIDE_SCH_T2_3: "당일 ~01:00",
  GUIDE_SCH_T2_4: "월별 AI 분석(monthly_summary), 브리핑 갱신",
